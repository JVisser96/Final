    ...
    $('.nextButton').on('click', function() {
		...
		function buttonSwitch(){
			...
			if(pageCounter == 11){
				...
				$('.prevButton').animate({"opacity" : "1"}, 300);
			}
		}
		...
		$('.aboutSection').on('click', function() {
				...
				$('#about, #about2, #two, #three, #four, #five, #six, #seven, #eight, #nine, #ten, #eleven, #twelve').animate({'top' : "+=" + total + "%"}, 900);
				pageCounter = 0;
				colorSwitch();
			});
    $('.webSection').on('click', function() {
				var moveAbout = pageCounter - 2;
